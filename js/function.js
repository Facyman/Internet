...
function AddNewColumn() {
    ...
    data['column'].push({id: getRandomInRange(1, 5000), title: 'Новоя колонка', item: []});
...
function addColumnItem(column_id, column_item_id) {
    ...
    data['column'][column_index]['item'].push({id: column_item_id, text: 'Новый задача', data: currect_date.getDate() + '.' + currect_date.getMonth()+1 + '.' + currect_date.getFullYear(), status: 'default', user: 'Everyone'});
